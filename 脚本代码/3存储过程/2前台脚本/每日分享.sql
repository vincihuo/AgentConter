...
IF EXISTS (SELECT *
FROM DBO.SYSOBJECTS
WHERE ID = OBJECT_ID(N'[dbo].PW_TimesReward') and OBJECTPROPERTY(ID, N'IsProcedure') = 1)
...
--变化前玩家的金币总数
DECLARE @StartInsureScore BIGINT
--变化前玩家的银行金币总数
DECLARE @StartDiamond BIGINT
---变化前玩家的钻石数
DECLARE @Dateid int
---
