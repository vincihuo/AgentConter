...
BEGIN
  ...
  BEGIN
    ...
    BEGIN
      insert into [WHQJTreasureDB].dbo.UserCurrency(UserID,Diamond,AwardTicket) values(@TargetUserID,0,0)
      SET @ReceiveBefore = 0
    END
  ...
  BEGIN
    ...
    BEGIN TRAN
      ...
      INSERT INTO WHQJRecordDB.DBO.RecordTreasureSerial
      (SerialNumber,MasterID,UserID,TypeID,CurScore,CurInsureScore,ChangeScore,ClientIP,CollectDate)
      VALUES(dbo.WF_GetSerialNumber(), 0, @TargetUserID, 11, @ReceiveBefore, @ReceiveBeforeInsure, @dwAward, @strClientIP, @DateTime)
