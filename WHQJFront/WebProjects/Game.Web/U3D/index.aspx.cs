...
namespace Game.Web.U3D
{
    public partial class index : System.Web.UI.Page
    {
        ...
        protected string PlatformDownloadOldUrl = string.Empty;
            ...
            if (!IsPostBack)
            {
                ...
                foreach (var item in list)
                {
                    if (item.ConfigKey == AppConfig.SiteConfigKey.MobilePlatformVersion.ToString())
                    {
                        ...
                        PlatformDownloadOldUrl = terminalType == 2 ? item.Field11 : item.Field12;
                    }
                ...
                Mobilebg = Fetch.GetUploadFileUrl(imgDomain, "/Site/u3dpcbg.png");
