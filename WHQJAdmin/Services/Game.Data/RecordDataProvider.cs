...
namespace Game.Data
{
    ...
    public class RecordDataProvider : BaseDataProvider, IRecordDataProvider
    {
        ...
        {
            PagerParameters pagerPrams = new PagerParameters("RecordBuyNewProperty", where, order, pageIndex, pageSize, null, "WEB_PageView_BuyProperty");
            return GetPagerSet(pagerPrams);
        }
        /// <summary>
        /// 分页获取数据列表
        ...
        {
            PagerParameters pagerPrams = new PagerParameters("RecordUseProperty", where, order, pageIndex, pageSize, null, "WEB_PageView_UseProperty");
            return GetPagerSet(pagerPrams);
        }
        /// <summary>
        /// 获取代理钻石信息
        ...
        {
            PagerParameters pagerPrams = new PagerParameters("RecordTask", where, order, pageIndex, pageSize, null, "WEB_PageView_TaskRecord");
            return GetPagerSet(pagerPrams);
        }
        #endregion
    }
