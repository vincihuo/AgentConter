...
namespace Game.Facade
{
    public class PlatformManagerFacade
    {
        ...
        {
            return _aidePlatformManagerData.GetList(tableName, where, order, pageIndex, pageSize, fields);
        }
        #endregion 公用分页
        ...
        /// </summary>
        /// <returns></returns>
        public DataSet GetBaseUsersList()
        {
            return _aidePlatformManagerData.GetBaseUsersList();
        }
        /// <summary>
        /// 管理员登录
        /// </summary>
        ...
        {
            return _aidePlatformManagerData.GetRoleList();
        }
        /// <summary>
        /// 获取管理员角色
        /// </summary>
