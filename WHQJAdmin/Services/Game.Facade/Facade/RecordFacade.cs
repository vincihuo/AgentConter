...
namespace Game.Facade
{
    ...
    public class RecordFacade
    {
        ...
        {
            return aideRecordData.GetList(tableName, where, order, pageIndex, pageSize, fields);
        }

        public PagerSet GetListLock(string tableName, string where, string order, int pageIndex, int pageSize, string fields = null)
        {
            return aideRecordData.GetListLock(tableName, where, order, pageIndex, pageSize, fields);
        }
        ...
        /// <param name="pageSize">页显示数</param>
        /// <returns></returns>
        public PagerSet GetPageBuyPropertyList(string where, string order, int pageIndex, int pageSize)
        {
            return aideRecordData.GetPageBuyPropertyList(where, order, pageIndex, pageSize);
        }
        /// <summary>
        /// 分页获取数据列表
        /// </summary>
        ...
        /// <param name="pageSize">页显示数</param>
        /// <returns></returns>
        public PagerSet GetPageUsePropertyList(string where, string order, int pageIndex, int pageSize)
        {
            return aideRecordData.GetPageUsePropertyList(where, order, pageIndex, pageSize);
        }
        /// <summary>
        /// 获取代理钻石信息
        /// </summary>
        ...
        /// <param name="pageSize">页显示数</param>
        /// <returns></returns>
        public PagerSet GetPageTaskRecordList(string where, string order, int pageIndex, int pageSize)
        {
            return aideRecordData.GetPageTaskRecordList(where, order, pageIndex, pageSize);
        }
        #endregion
