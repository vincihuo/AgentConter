...
namespace Game.IData
{
    ...
    public interface IRecordDataProvider //: IProvider
    {
        ...
        /// <param name="pageSize">页显示数</param>
        /// <returns></returns>
        PagerSet GetPageBuyPropertyList(string where, string order, int pageIndex, int pageSize);
        /// <summary>
        /// 分页获取数据列表
        /// </summary>
        /// <param name="where">查询条件</param>
        ...
        /// <param name="pageSize">页显示数</param>
        /// <returns></returns>
        PagerSet GetPageUsePropertyList(string where, string order, int pageIndex, int pageSize);
        /// <summary>
        /// 获取代理钻石信息
        /// </summary>
        ...
        /// <param name="pageSize">页显示数</param>
        /// <returns></returns>
        PagerSet GetPageTaskRecordList(string where, string order, int pageIndex, int pageSize);
        #endregion
    }
}