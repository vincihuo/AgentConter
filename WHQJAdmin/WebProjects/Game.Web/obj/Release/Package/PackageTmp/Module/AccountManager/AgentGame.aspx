<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentGame.aspx.cs" Inherits="Game.Web.Module.AccountManager.AgentGame" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" class="btn wd2" value="添加游戏" onclick="openWindowOwn('AddGame.aspx?typeid=2','添加游戏',600,280)">
