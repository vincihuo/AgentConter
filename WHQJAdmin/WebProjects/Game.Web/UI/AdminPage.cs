...
namespace Game.Web.UI
{
    ...
    public abstract partial class AdminPage : Page
    {
        ...
        /// <param name="typeid">类型标识</param>
        /// <returns></returns>
        protected string GetGamePackageGoodsType(int typeid)
        {
            return EnumHelper.GetDesc(typeof(GamePackageGoodsType), typeid);
        }
        ...
        /// <param name="typeid">类型标识</param>
        /// <returns></returns>
        protected string GetGamePackageGoodsProperty(int typeid)
        {
            return EnumHelper.GetDesc(typeof(GamePackageGoodsProperty), typeid);
        }
        /// <summary>
        /// 获取奖券记录类型
        /// </summary>
        ...
        /// <returns></returns>
        protected string GetAwardTicketSerialType(int typeid)
        {
            return EnumHelper.GetDesc(typeof(AwardTicketSerialType), typeid);
        }
