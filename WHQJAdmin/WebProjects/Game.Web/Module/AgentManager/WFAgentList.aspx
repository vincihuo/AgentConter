<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFAgentList.aspx.cs" Inherits="Game.Web.Module.AgentManager.WFAgentList" %>
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
                <tr align="center" class="bold">
                    <td class="listTitle2">上级ID
                    </td>
                    <td class="listTitle2">会员ID
                    </td>
                    <td class="listTitle2">有效下注
                    </td>
                    <td class="listTitle2">奖励
                    </td>
                    <td class="listTitle2">团队人数
                    </td>
                    <td class="listTitle2">团队业绩
                    </td>
