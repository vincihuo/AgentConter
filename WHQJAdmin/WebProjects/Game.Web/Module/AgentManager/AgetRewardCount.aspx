    ...
    <form id="form1" runat="server">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
            <tr>
                ...
                <td width="1232" height="25" valign="top" align="left">你当前位置：代理系统
                </td>
            </tr>
        </table>
                ...
                <asp:Repeater ID="rptDataList" runat="server">
                    <ItemTemplate>
                        <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                            ...
                            <td>
                                <a class="l" href="javascript:void(0)" style="<%# GetStyle(Convert.ToInt32(Eval("BeggarNumber")))%>" onclick="Redirect('AgentUserUnder.aspx?param='+<%# Eval("UserID")%>);">下级报表</a>
                                <a class="l" href="javascript:void(0)" style="<%# GetStyle(Convert.ToInt32(Eval("ParentID")))%>" onclick="Redirect('AgetRewardCount.aspx?param='+<%# Eval("ParentID")%>);">查看上级</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
