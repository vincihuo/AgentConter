...
{
    public partial class RecordGameSignInList : AdminPage
    {
        #region 事件绑定
        ...
        private void SetCondition()
        {
            ...
            if (ddlSignType.SelectedValue != "-1")
            {
                condition.AppendFormat(" AND SignType={0} ", ddlSignType.SelectedValue);
            }
        ...
        {
            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetList(RecordGameSignIn.Tablename,
