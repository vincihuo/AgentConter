...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
       ...
       <%-- <tr >
            ...
            <td>
                <asp:TextBox ID="txttitle" runat="server" CssClass="text" MaxLength="500" Width="200px"></asp:TextBox>
                <span class="hong">*</span>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="请输入描述" ControlToValidate="txttitle" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>--%>
        <tr>
            <td class="listTdLeft">
