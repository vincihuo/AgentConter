<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChanelPage.aspx.cs" Inherits="Game.Web.Module.FilledManager.ChanelPage" %>
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
                <tr align="center" class="bold">
                    ...
                    <td class="listTitle1">通道名称
                    </td>
                    <td class="listTitle2">通道类型
                    </td>
