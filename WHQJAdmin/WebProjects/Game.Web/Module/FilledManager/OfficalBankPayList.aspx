    ...
    <form id="form1" runat="server">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
            <tr>
                ...
                <td width="1232" height="25" valign="top" align="left">你当前位置：充值系统 - 转账渠道
                </td>
            </tr>
        </table>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td class="titleOpBg Lpd10">
                    <input id="btnNew1" type="button" class="btn wd1" value="新增" onclick="Redirect('OfficalBankPayInfo.aspx')" />
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
                <tr align="center" class="bold">
                    ...
                    <td class="listTitle2">户名
                    </td>
                    <td class="listTitle2">银行名称
                    </td>
                    <td class="listTitle2">银行卡号
                    </td>
