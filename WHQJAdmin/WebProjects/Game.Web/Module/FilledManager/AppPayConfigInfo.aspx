        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="True">
            <ContentTemplate>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlProductType" runat="server" Width="155" Height="24" CssClass="text" AutoPostBack="True" OnSelectedIndexChanged="ddlProductType_SelectedIndexChanged">
                                ...
                                <%--   <asp:ListItem Text="U3D普通" Value="2"></asp:ListItem>
                            <asp:ListItem Text="U3D苹果" Value="3"></asp:ListItem>--%>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropFirstType" runat="server" Width="155" Height="24" CssClass="text">
                    ...
                    <tr>
                        <td class="listTdLeft">产品价格：
                        </td>
                        <td>
                            <asp:TextBox ID="txtPrice" runat="server" CssClass="text" MaxLength="9"></asp:TextBox>
                            <span class="hong">*</span>
                    ...
                    <tr>
                        <td class="listTdLeft">图标类型：
                        </td>
                        <td>
                            <asp:RadioButtonList ID="rbImage" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Text="微量钻石图标" Value="1" Selected="True"></asp:ListItem>
                                <asp:ListItem Text="较少钻石图标" Value="2"></asp:ListItem>
                                <asp:ListItem Text="少量钻石图标" Value="3"></asp:ListItem>
                                <asp:ListItem Text="中等钻石图标" Value="4"></asp:ListItem>
                                <asp:ListItem Text="偏高钻石图标" Value="5"></asp:ListItem>
                                <asp:ListItem Text="多数钻石图标" Value="6"></asp:ListItem>
                                <asp:ListItem Text="大量钻石图标" Value="7"></asp:ListItem>
                                <asp:ListItem Text="超级钻石图标" Value="8"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>

                    <tr>
                        <td class="listTdLeft">首冲额外赠送：
                        </td>
                        <td>
