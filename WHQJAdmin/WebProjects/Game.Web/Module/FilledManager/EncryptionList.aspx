<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EncryptionList.aspx.cs" Inherits="Game.Web.Module.FilledManager.EncryptionList" %>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td class="titleOpBg Lpd10">
                    <input id="btnNew1" type="button" class="btn wd1" value="新增" onclick="Redirect('EncryptionInfo.aspx')" />
                ...
                <asp:Repeater ID="rptDataList" runat="server">
                    <ItemTemplate>
                        <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                            ...
                            <td>
                                <a href="EncryptionInfo.aspx?param=<%# Eval( "id" ).ToString( )%>" class="l">编辑</a>
                            </td>
                            <td>
                                <%# Eval("name")%>
                            </td>
