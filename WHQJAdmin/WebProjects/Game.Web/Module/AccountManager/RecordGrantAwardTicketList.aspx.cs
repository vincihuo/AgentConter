...
{
    public partial class RecordGrantAwardTicketList : AdminPage
    {
        ...
        private void BindData()
        {
            ...
            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetList(RecordGrantAwardTicket.Tablename, condition.ToString(),
