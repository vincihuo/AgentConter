...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left" style="width: 1232px; height: 25px; vertical-align: top; text-align: left;">目前操作功能：用户信息
            </td>
        </tr>
    </table>
    ...
    <form runat="server" id="form1">
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
            ...
            <tr>
                ...
                <td style="width: 150px;">
                    <asp:TextBox ID="TextBank" CssClass="text" MaxLength="40" runat="server"></asp:TextBox>
                </td>
            </tr>

            <tr>
                <td class="listTdLeft">个性签名：
                </td>
                <td colspan="3">
