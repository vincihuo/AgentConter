...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
            <tr>
                <td align="center" style="width: 80px">账号查询：
                </td>
                <td>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
            <tr>
                ...
                <td align="center" style="width: 80px">注册地址：
                </td>
                <td>
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="text"></asp:TextBox>
                </td>
                <td align="center" style="width: 80px">登陆地址：
                </td>
                <td>
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
                <tr align="center" class="bold">
                    ...
                    <td class="listTitle2">用户标识
                    </td>
                    <td class="listTitle2">游戏ID
                    </td>
                    <td class="listTitle2">昵称
                    </td>
                    <td class="listTitle2">性别
                    </td>
                    <td class="listTitle2">代理
                    </td>
                    <td class="listTitle2">注册时间
                    </td>
                    <td class="listTitle2">注册地址
                    </td>
                    <td class="listTitle2">登录次数
                    </td>
                    <td class="listTitle2">最后登录时间
                    </td>
                    <td class="listTitle2">最后登录地址
                    </td>
                    <td class="listTitle2">注册来源
                    </td>
                    <td class="listTitle1">状态
                    </td>
                ...
                <asp:Repeater ID="rptDataList" runat="server">
                    <ItemTemplate>
                        <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                            ...
                            <td>
                                <a class="l" href="javascript:void(0);" onclick="openWindowOwn('/Module/AccountManager/AccountsBaseInfo.aspx?param=<%#Eval("UserID").ToString() %>','<%#Eval("UserID").ToString() %>',880,790);">
                            ...
                            <td>
                                <%# GetAgentSpread( Convert.ToInt32( Eval( "SpreaderID" ) ), Convert.ToInt32( Eval( "UserID" )) ) %>
                            </td>
                            <td>
                            ...
                            <td>
                                <a class="l" href="javascript:void(0)" onclick="openWindowOwn('GrantGameID.aspx?param=<%#Eval("UserID").ToString() %>','_GrantGameID',600,300);">赠送靓号</a>
                            </td>
                        </tr>
                    </ItemTemplate>
