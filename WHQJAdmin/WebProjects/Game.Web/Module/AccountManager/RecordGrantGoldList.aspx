<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGrantGoldList.aspx.cs" Inherits="Game.Web.Module.AccountManager.RecordGrantGoldList" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
            <tr>
                ...
                <td width="1232" height="25" valign="top" align="left">你当前位置：用户系统 - 后台赠送金币
                </td>
            </tr>
        </table>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
            <tr>
                <td height="28">
                    <ul>
                        <li class="tab1">金币记录</li>
                        <li class="tab2" onclick="Redirect('RecordGrantDiamondList.aspx')">钻石记录</li>
                        <li class="tab2" onclick="Redirect('RecordGrantAwardTicketList.aspx')">奖券记录</li>
                    </ul>
                </td>
            </tr>
        </table>
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7" id="list">
                <tr align="center" class="bold">
                    <td class="listTitle2">赠送时间
                    </td>
                    <td class="listTitle2">游戏ID
                    </td>
                    <td class="listTitle2">玩家昵称
                    </td>
                    <td class="listTitle2">赠送前身上金币
                    </td>
                    <td class="listTitle2">赠送金币
                    </td>
                    <td class="listTitle2">赠送后身上金币
                    </td>
                    <td class="listTitle2">操作管理员
                    </td>
                    <td class="listTitle2">赠送地址
                    </td>
                </tr>
                <asp:Repeater ID="rptDataList" runat="server">
                    <ItemTemplate>
                        <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                            ...
                            <td>
                                <%#FacadeManage.ConversionMoneyToShow(Eval( "CurGold" ).ToString()) %>
                            </td>
                            <td>
                                <%#FacadeManage.ConversionMoneyToShow(Eval( "AddGold" ).ToString()) %>
                            </td>
                            <td>
                                <%#FacadeManage.ConversionMoneyToShow(Convert.ToInt64(Eval( "CurGold" ))+Convert.ToInt64(Eval( "AddGold" ))) %>
                            </td>
                            <td>
                                <%# GetMasterUser(Convert.ToInt32(Eval( "MasterID" )))%>
                            </td>
                            <td>
                                <%# Eval( "ClientIP" )%>
                            </td>
