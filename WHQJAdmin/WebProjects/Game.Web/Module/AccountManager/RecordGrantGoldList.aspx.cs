...
{
    public partial class RecordGrantGoldList : AdminPage
    {
        ...
        private void BindData()
        {
            ...
            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetList(RecordGrantTreasure.Tablename, condition.ToString(), 
